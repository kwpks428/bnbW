#!/bin/bash
# Railway CLI 部署脚本 - 即时数据监听服务

echo "🚀 开始部署 BNB 即时数据监听服务到 Railway..."
...
echo "✅ 部署完成！"
echo "📊 状态检查端点: https://your-app.railway.app/status"
echo "🔌 WebSocket端点: wss://your-app.railway.app/ws"
